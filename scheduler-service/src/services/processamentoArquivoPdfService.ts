...
export const coletarEEnfileirarDadosPdf = async (): Promise<string | null> => {
    try {
        ...
        protocoloId,
        tipoArquivo: 'pdf', // Se você estiver disparando para a fila de PDF
        ...
        const ROUTING_KEY = 'reports.v1.trigger.daily_report_pdf';
        ...
        await publisherEvent(
            ...
            'reports.v1.trigger.processa_pdf', // Chave de Rota Principal
