...
import { DadosLinhaSharepoint } from '../models/oneDriveModel';

export class OneDriveService {
    async obterDadosBrutosBypass(): Promise<Record<string, string>[]> {
    ...
    // 2. Parâmetro tipado para receber a estrutura das linhas do Sharepoint
        async salvarNoSharepoint(dadosParaSalvar: DadosLinhaSharepoint[]): Promise<void> {
