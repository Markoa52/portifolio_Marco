...
export const CAMINHO_EXCELW = 'C:\\Site\\6-API-Microservicos_fullStack-V3\\api-automacao-mvc-ts\\WebhookGLPI.xlsx';

// Constantes da Automação de E-mails / SharePoint
export const CAMINHO_EXCEL = 'C:\\Site\\6-API-Microservicos_fullStack-V3\\api-automacao-mvc-ts\\Email.xlsx'
