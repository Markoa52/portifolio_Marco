...
export const Dashboard: React.FC = () => {
  ...
  return (
    // container limita a largura em 1200px e m-auto centraliza de acordo com o Header
    <div className="container my-4 p-0 px-2 text-start" style={{ maxWidth: "1200px", margin: "0 auto" }}>
       ...
       <div className="d-flex align-items-center justify-content-between border-bottom pb-3 mb-4">
        <h2 className="fs-4 fw-bold text-dark m-0 d-flex align-items-center gap-2">
          <BarChart3 size={22} className="text-primary" /> Dashboard de Indicadores GLPI
        </h2>
        {!carregando && (
      ...
      {carregando ? (
        ...
        <>
          ...
          <div className="row g-4 m-0 mb-4">
            
            {/* Card 1: Não Atendidos (Crítico/Alerta) */}
            <div className="col-md-4 ps-0">
              {/* bg-white garante a mesma cor branca limpa dos outros cards do seu sistema */}
